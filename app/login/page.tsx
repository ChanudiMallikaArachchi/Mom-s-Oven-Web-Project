    ...
    <main className="min-h-screen bg-[#FFF8F2] pb-24 pt-28">
      <div className="mx-auto max-w-md px-6">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold text-[#4A2C1D]">Welcome Back</h1>
          <p className="mt-2 text-sm text-gray-600">
            Log in to your Mom&apos;s Oven account to manage orders and rewards.
          </p>
        </div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 py-2.5 text-xs font-semibold text-gray-700 transition hover:bg-gray-50"
                >
